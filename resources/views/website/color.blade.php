                    ...
                    <div class="shop__details-images-wrap">
                        <ul class="nav nav-tabs" id="imageTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="one-tab" data-bs-toggle="tab" data-bs-target="#one" type="button" role="tab" aria-controls="one" aria-selected="true">
                                    <img src="assets/img/Game/color/2.png" alt="img">
                                </button>
                            </li>
                            <!--
                                                        <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-content" id="imageTabContent">
                            <div class="tab-pane show active" id="one" role="tabpanel" aria-labelledby="one-tab">
                                <a href="assets/img/Game/color/2.png" class="popup-image"><img src="assets/img/Game/color/2.png" alt="img"></a>
                            </div>
                            <!--
                    ...
                    <div class="shop__details-content">
                        ...
                        <div class="shop__details-qty">
                            <div class="cart-plus-minus d-flex flex-wrap align-items-center">
                                ...
                                <a target="_blank" href="https://apps.apple.com/us/app/color-swap-the-color-puzzle-game/id1084788167" class="shop__details-cart-btn"><img src="assets/img/safari.png">Safari App</a>
                ...
                <div class="row" style="justify-content: center">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <div class="videoBox">
                            ...
                            <iframe  src="https://www.youtube.com/embed/VYq0zgCRy2E?si=Bo-CnG84bJ5bkr7m" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </div>

                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="breadcrumb__content">
                                <h2 class="title">Letters Hero</h2>
                    ...
                    <div class="shop__details-images-wrap">
                        <ul class="nav nav-tabs" id="imageTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="one-tab" data-bs-toggle="tab" data-bs-target="#one" type="button" role="tab" aria-controls="one" aria-selected="true">
                                    <img src="assets/img/Game/letters_hero/l1.png" alt="img">
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="two-tab" data-bs-toggle="tab" data-bs-target="#two" type="button" role="tab" aria-controls="two" aria-selected="false">
                                    <img src="assets/img/Game/letters_hero/l2.png" alt="img">
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="two-tab" data-bs-toggle="tab" data-bs-target="#three" type="button" role="tab" aria-controls="two" aria-selected="false">
                                    <img src="assets/img/Game/letters_hero/l3.png" alt="img">
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="two-tab" data-bs-toggle="tab" data-bs-target="#four" type="button" role="tab" aria-controls="two" aria-selected="false">
                                    <img src="assets/img/Game/letters_hero/l4.png" alt="img">
                                </button>
                            </li>
                            <!--
                                                        <li class="nav-item" role="presentation">
                                                            <button class="nav-link" id="two-tab" data-bs-toggle="tab" data-bs-target="#fife" type="button" role="tab" aria-controls="two" aria-selected="false">
                                                                <img src="assets/img/Game/letters_hero/l5.jpg" alt="img">
                                                            </button>
                                                        </li>
                            -->
                        ...
                        <div class="tab-content" id="imageTabContent">
                            <div class="tab-pane show active" id="one" role="tabpanel" aria-labelledby="one-tab">
                                <a href="assets/img/Game/letters_hero/l1.png" class="popup-image"><img src="assets/img/Game/letters_hero/l1.png" alt="img"></a>
                            </div>
                            <div class="tab-pane" id="two" role="tabpanel" aria-labelledby="two-tab">
                                <a href="assets/img/Game/letters_hero/l2.png" class="popup-image"><img src="assets/img/Game/letters_hero/l2.png" alt="img"></a>
                            </div>
                            <div class="tab-pane" id="three" role="tabpanel" aria-labelledby="two-tab">
                                <a href="assets/img/Game/letters_hero/l3.png" class="popup-image"><img src="assets/img/Game/letters_hero/l3.png" alt="img"></a>
                            </div>
                            <div class="tab-pane" id="four" role="tabpanel" aria-labelledby="two-tab">
                                <a href="assets/img/Game/letters_hero/l4.png" class="popup-image"><img src="assets/img/Game/letters_hero/l4.png" alt="img"></a>
                            </div>
                            <!--
                                                        <div class="tab-pane" id="four" role="tabpanel" aria-labelledby="two-tab">
                                                            <a href="assets/img/Game/letters_hero/l5.PNG" class="popup-image"><img src="assets/img/Game/letters_hero/l5.PNG" alt="img"></a>
                                                        </div>
                            -->
                    ...
                    <div class="shop__details-content">
                        ...
                        <div class="shop__details-qty">
                            <div class="cart-plus-minus d-flex flex-wrap align-items-center">
                                ...
                                -->
                                <!--
                                                                <a target="_blank" href="https://play.google.com/store/apps/details?id=com.trinelabs.kooz&hl=en&gl=US" class="shop__details-cart-btn"><img src="assets/img/playstore.png">Play Store</a>
                                                                <a target="_blank" href="https://apps.apple.com/us/app/kooz/id6444831787" class="shop__details-cart-btn"><img src="assets/img/safari.png">Safari App</a>
                                -->
                ...
                <div class="row" style="justify-content: center">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <div class="videoBox">
                            ...
                            <iframe  src="https://www.youtube.com/embed/F_-nJJuJoxA?si=kbryoAmb0bEKP_eZ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </div>
